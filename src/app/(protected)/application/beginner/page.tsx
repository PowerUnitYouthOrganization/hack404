    ...
    <div className="flex flex-col min-h-screen w-full gap-3 items-start bg-gradient-to-b from-[rgba(14,17,22,0.25)] to-[#0E1116]">
      ...
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-[1.1fr_2fr] gap-4 p-2 md:p-12">
        ...
        <div className="flex flex-col justify-start border border-cyan-400/20 bg-[rgba(14,17,22,0.25)] backdrop-blur-[25px] p-4 md:p-10 min-h-[300px] md:min-h-[500px] h-full">
          <h1 className="text-white text-3xl md:text-5xl font-(family-name:--font-heading) mb-2 md:mb-4">
            Apply
          </h1>
          <h2 className="text-white text-2xl md:text-3xl font-(family-name:--font-heading) font-light mb-4 md:mb-8">
            Attend Hack404!
          </h2>
          <p className="text-white/60 text-sm md:text-base font-light max-w-md">
            The beginner stream is perfect for those new to hackathons or with
            limited experience. You'll get extra mentorship, beginner-friendly
            workshops, and a supportive environment to learn and grow. No prior
            hackathon experience required - just bring your curiosity and
            enthusiasm!
          </p>
        </div>
        {/* Right Panel (Form) */}
        <div className="flex flex-col gap-4 md:gap-8 border border-cyan-400/20 bg-gradient-to-br from-[rgba(48,242,242,0.10)] to-[rgba(48,242,242,0.05)] backdrop-blur-[25px] p-4 md:p-8">
          <ApplicationForm
            ...
            shortAnswer1={{
              label:
                "What excites you about tech? Please share some of your passions and interest.",
              maxLength: 750,
            }}
            shortAnswer2={{
