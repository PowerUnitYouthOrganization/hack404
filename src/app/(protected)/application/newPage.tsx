...
export default function ApplicationPage() {
    ...
    switch (step) {
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <Select
                ...
                options={["Asian", "Black", "Latino", "White", "Indigenous", "Other", "Prefer not to say"]}
                required
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex gap-4">
              <Select
                ...
                options={[{ label: "Beginner", value: "beginner" }, { label: "Advanced", value: "normal" }]}
      ...
      case 3:
        return (
          <div className="flex flex-col gap-6">
            <div>
              <label className="text-white text-sm mb-2 block">What workshops would you like to see at Hack 404? (choose up to 3)</label>
              <div className="flex flex-wrap gap-2">
                {workshopOptions.map((option) => (
                  <button
                    ...
                    disabled={
                      !form.workshops.includes(option) && form.workshops.length >= 3
                    }
                  >
                    {option}
                  </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="usedAI" className="text-white text-sm">
                Did you use AI for your application? (just for data collection, not for evaluation)
              </label>
            </div>
            <div className="flex items-center gap-2">
              <Checkbox
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
      <div className="flex flex-1 mx-auto w-full max-w-6xl mt-12 shadow-lg rounded-lg overflow-hidden" style={{ height: "80vh" }}>
        {/* Left static section */}
        <div className="w-1/2 bg-gradient-to-br from-[#1a2a6c] via-[#1e3c72] to-[#2e8b57] p-12 flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-white text-3xl font-light mb-8">Attend Hack404!</h2>
          </div>
        ...
        <div className="w-1/2 relative overflow-hidden flex flex-col justify-between bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#43cea2] p-12">
          <div className="flex justify-between items-center mb-8">
            <span className="text-white text-lg font-light">{stepTitles[step]}</span>
            <span className="text-white text-xs opacity-60">Step {step + 1}/4</span>
          </div>
          <form
          ...
          >
            ...
            <div className="flex justify-between items-center mt-8">
              {step > 0 ? (
                <RoundedButton type="button" onClick={prevStep} className="bg-cyan-400/80 text-black px-6 py-2 rounded-full">
                  Back
                </RoundedButton>
              ) : <span />}
              {step < 3 ? (
                <RoundedButton type="submit" className="bg-wlime text-wblack dark:text-white px-8 py-3 rounded-full" disabled={!validateStep(step, form)}>
                  Continue
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1C1B1F"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z" /></svg>
                </RoundedButton>
              ) : (
                <RoundedButton type="submit" className="bg-wlime text-wblack dark:text-white px-8 py-3 rounded-full" disabled={!validateStep(step, form)}>
                  Submit
            ...
            <div className="text-white text-xs mt-2 opacity-70">Make sure details are correct</div>
          </form>
        </div>
      </div>
    </div>
