...
import GradientBackground from "@/components/gradient-background"; // Update path as needed
        ...
        <div className="w-full max-w-6xl border border-white/10 rounded-lg overflow-hidden grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10 relative z-10 mx-auto">
          ...
          <div className="p-10 space-y-6 relative">
            <div>
              {step === 0 ? (
                <>
                  <h1 className="text-3xl font-medium">Welcome to Hack404</h1>
                  <h2 className="text-2xl mt-2">Launchpad</h2>
                  <br /><br /><br /><br />
                  <p className="text-sm text-white/70 max-w-xs">Applications close June 20</p>
                </>
              ) : (
                <>
              ...
              {step === 1 && (
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <input type="text" name="firstName" value={form.firstName} onChange={handleChange} placeholder="First Name (Legal)" required className="p-3 bg-white/5 border border-white/20 rounded-lg placeholder-white/50" />
                    ...
                    <input type="text" name="preferredName" value={form.preferredName || ""} onChange={handleChange} placeholder="First Name (Preferred)" className="p-3 bg-white/5 border border-white/20 rounded-lg placeholder-white/50" />
                    <input type="number" name="age" value={form.age || ""} onChange={handleChange} placeholder="Age" className="p-3 bg-white/5 border border-white/20 rounded-lg placeholder-white/50" />
                    <select name="gender" value={form.gender || ""} onChange={handleChange} required className="p-3 bg-white/5 border border-white/20 rounded-lg text-white">
                    ...
                    <select name="ethnicity" value={form.ethnicity || ""} onChange={handleChange} required className="p-3 bg-white/5 border border-white/20 rounded-lg text-white placeholder-white/70">
