      ...
      >
        ...
        >
          ...
          <Section
            ...
            style={{ padding: "0 36px", backgroundColor: "#0e1116" }}
          >
            <div
            ...
            >
              ...
              <span style={{ color: "#ffffff", fontWeight: 400 }}>
                hacker applications will open shortly.
              </span>
            </Text>
              ...
              <Row style={{ height: "54px" }}>
                ...
                >
                  <div style={{ display: "inline-block" }}>
                    <Text
                      style={{
                        fontFamily:
                          "'FH Lecturis', 'DM Sans', Arial, sans-serif",
                        fontWeight: 300,
                        fontSize: "20px",
                        lineHeight: "100%",
                        letterSpacing: "-0.6px",
                ...
                >
                  ...
                  >
                    ...
                    >
                      <path
                        d="M161 38.497C161 39.5579 160.579 40.5753 159.828 41.3254L148.325 52.8284C147.575 53.5786 146.558 54 145.497 54H4.5C2.29087 54 0.5 52.2091 0.5 50V4C0.5 1.79086 2.29086 0 4.5 0H157C159.209 0 161 1.79086 161 4V38.497Z"
                        fill="white"
                      />
                    </svg>
                    <Link
                      ...
                      >
                        <g id="arrow_forward">
                          ...
                          <g mask="url(#mask0_1_130)">
                            <path
                              id="arrow_forward_2"
                              d="M11.1981 9.69232H2.76929V8.3077H11.1981L7.32121 4.43078L8.30775 3.46155L13.8462 9.00001L8.30775 14.5385L7.32121 13.5692L11.1981 9.69232Z"
                              fill="#1C1B1F"
                            />
                          </g>
                        </g>
          ...
          <Section className="footer" style={{ padding: "0 0 32px" }}>
            <div
              ...
              style={{
                height: "2px",
                backgroundImage:
                  "linear-gradient(to right, #3023AE, #53A0FD, #6DFD9C)",
                marginBottom: "32px",
                width: "100%",
              }}
            ></div>
