 ...
 */
export default function GradientBorder({ reverse = false, children }: { reverse?: boolean; children?: React.ReactNode }) {
	...
	return <div className={`p-[1px] rounded-lg bg-gradient-to-r ${gradient}`}></div>;
}
