...
export default function NotificationHandler() {
  ...
  useEffect(() => {
    ...
    const hasAskedBefore = sessionStorage.getItem(
      "notificationPermissionAsked",
    );
    const hasDeclined = sessionStorage.getItem(
  ...
  return (
    <div>
      <Dialog
        open={showPermissionDialog && status == "authenticated"}
            ...
            <DialogDescription asChild>
              <div className="text-left space-y-4">
                ...
                <p className="text-sm text-white/60">
                  You can disable these notifications at any time in your
                  browser settings.
                </p>
              </div>
            </DialogDescription>
