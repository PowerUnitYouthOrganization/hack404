...
export default function WorkshopsCard({ options, selectedWorkshops, onWorkshopSelect, otherWorkshop = "", onOtherWorkshopChange }: {
  options: string[];
      ...
      <div className="p-6">
        <div className="flex flex-col gap-3">
          {allOptions.map((option) => (
            <label key={option} className="flex items-center gap-3 cursor-pointer text-white text-sm font-light py-1">
              <Checkbox
