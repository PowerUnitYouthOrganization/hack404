...
const styles = {
  ...
  buttonContainer: {
    background: 'linear-gradient(90deg, #181C3A 0%, #1B2B3A 100%)', // darker gradient
    borderRadius: '16px',
    padding: '0',
    display: 'flex',
    alignItems: 'center',
        ...
        <Container style={styles.emailContainer}>
          ...
          <Section style={styles.mainContent}>
            <div style={styles.headingContainer}>
              <Text style={styles.heading}>Ready to see your<br />launchpad?</Text>
            </div>
            <Text style={styles.greeting}>Hey {username} <span role="img" aria-label="wave">👋</span></Text>
            <Text style={styles.paragraph}>Thank you for creating a Hack404 account!</Text>
            <Text style={styles.paragraph}>Click the button below to login and start your application.</Text>
            <div style={styles.buttonRow}>
              <div style={styles.buttonContainer}>
                <span style={styles.buttonText}>Access your account</span>
                <a href={loginLink} style={{...styles.loginButton, fontFamily: "'FH Lecturis', 'DM Sans', Arial, sans-serif"}} target="_blank" rel="noopener noreferrer">
                  Log In
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{marginLeft: '8px'}} xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 5L20 12L13 19" stroke="#0e1116" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M20 12H4" stroke="#0e1116" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
              </div>
            </div>
            <Text style={styles.expires}>This button will expire in {expiresInMinutes} minutes.</Text>
