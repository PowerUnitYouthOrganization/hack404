...
function TextSectionTitle({ 
  ...
  return (
    <h1
      className={cn(
        "text-5xl font-extralight font-(family-name:--font-heading) leading-[110%] tracking-[-0.2px]",
        className
      )}
      {...props}
    >
...
function TextSectionContent({ 
  ...
  return (
    <p
      className={cn(
        "text-justify text-2xl font-(family-name:--font-heading-light) leading-[110%] tracking-[-0.2px]",
        className
      )}
      {...props}
    >
